...
The study has been conducted from April 2024 to August 2024.
...
1.  Firstly, for the state level, we have intentionally selected 6 localities to represent different characteristics (distance from origin, clashes, & center of the state). Elbuhairah and Barbar localities were not included or weakly represented as they has least number of IDPs hosted.  

2.  At the locality level, we conveniently selected the major city (urban, Atbara) and at least one village (rural).

3.  Thirdly, participants were selected from different settings to guarantee taking diverse areas (households, health facilities, market, housing centres) and also to keep the privacy of the participants when speaking freely about their neighbours.
