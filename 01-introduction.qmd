...
To study the social cohesion and resilience between internally displaced people (IDPs) and host communities & well-being during armed conflict in River Nile state, Sudan 2024
...
3.  To identify key factors (based on demographics, socio-economic factors, length of displacement, etc.) that contribute to or hinder social cohesion and resilience.
